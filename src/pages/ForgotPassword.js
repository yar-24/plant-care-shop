...
const ForgotPassword = () => {
  ...
  return (
    ...
    <Container>
      <Typography variant="h4" component="h4" gutterBottom style={{ fontFamily: 'Comfortaa', fontWeight:'800' }}>
        {locale === 'id' ? 'Halaman Lupa Kata Sandi' : 'Forgot Password Page'}
      </Typography>
      <Typography variant="h5" component="h3" gutterBottom style={{ fontFamily: 'Inter', fontWeight:'500' }}>
